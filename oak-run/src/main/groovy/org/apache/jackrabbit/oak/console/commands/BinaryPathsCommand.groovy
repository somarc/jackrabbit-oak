...
class BinaryPathsCommand extends CommandSupport {
    ...
    private void loadProperties() {
        try {
            InputStream is = this.class.getResourceAsStream("BinaryPathsCommand.properties")
            if (is != null) {
    ...
    String getDescription() {
        return commandProperties.getProperty("command.description", "Finds JCR paths for given blob IDs")
    }
    
    @Override
    String getUsage() {
        return commandProperties.getProperty("command.usage", "<blob-ids-file>")
    }
    
    @Override
    String getHelp() {
        return commandProperties.getProperty("command.help", "Reads blob IDs from file and finds their JCR paths in the repository")
    }
