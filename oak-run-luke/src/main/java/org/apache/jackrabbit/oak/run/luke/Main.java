...
import static org.apache.jackrabbit.oak.run.luke.AvailableLukeModes.MODES;

/**
 * Main entry point for oak-run-luke CLI.
 * Provides LUKE-based index inspection and analysis capabilities.
 */
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        Utils.printProductInfo(
            args,
            Main.class.getResourceAsStream("/META-INF/maven/org.apache.jackrabbit/oak-run-luke/pom.properties"));
